...
df1.to_excel('successors_lower_rate-1.xlsx', sheet_name='Sheet1')
df2.to_excel('lower_has_successors-1.xlsx', sheet_name='Sheet1')
#df3.to_excel('lower_in_network_successors.xlsx', sheet_name='Sheet1')
