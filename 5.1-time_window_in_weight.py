			...
			if node1 in V.nodes():#确认跌停的这只股票在网络中
				...
				if d:#确定跌停的这只股票有predecessors
					...
					for node2 in d:
						...
						xx = V.get_edge_data(node2, node1)[0]['weight']
						#print xx
