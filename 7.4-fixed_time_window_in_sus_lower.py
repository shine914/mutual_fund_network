...
df1.to_excel('predecessors_sus_lower_rate.xlsx', sheet_name='Sheet1')
df2.to_excel('sus_lower_has_predecessors.xlsx', sheet_name='Sheet1')
df3.to_excel('sus_lower_in_network_predecessors.xlsx', sheet_name='Sheet1')
